...
public class StudentsDashboard extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudentsDashboard frame = new StudentsDashboard();
...
//				totalCoursebtn.setText(totalTutor);
		...
		searchStudentf.setBounds(47, 140, 270, 31);
		...
		progressbtn.setBounds(390, 140, 200, 30);
