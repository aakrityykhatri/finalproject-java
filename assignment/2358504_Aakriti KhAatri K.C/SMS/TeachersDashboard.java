...
public class TeachersDashboard extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TeachersDashboard frame = new TeachersDashboard();
...
//				totalCoursebtn.setText(totalTutor);
		...
		courseSearchf.setBounds(53, 140, 250, 31);
		...
		txtSearchTutor.setBounds(51, 146, 250, 31);
		...
		searchStudentf.setBounds(47, 140, 230, 31);
		...
		JButton asignMark = new JButton("Asign Mark");
		asignMark.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				addResult obj = new addResult();
				
				obj.setVisible(true);
				
			}
		});
		asignMark.setForeground(UIManager.getColor("Button.disabledShadow"));
		asignMark.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 12));
		asignMark.setBackground(new Color(240, 240, 240));
		asignMark.setBounds(310, 140, 125, 30);
		
		studentspanel.add(asignMark);
		...
		progressbtn.setForeground(UIManager.getColor("Button.disabledShadow"));
		progressbtn.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 12));
		progressbtn.setBackground(new Color(240, 240, 240));
		progressbtn.setBounds(472, 140, 125, 30);
		
		

		
		studentspanel.add(progressbtn);
